  ...
  return (
    <>
      ...
      <div className=' bg-gray-900 text-white mt-24 mb-25 p-5'>
        ...
        {/* Grid */}
        <div className='mt-10 text-white grid grid-cols-2 place-items-center gap-4'>
          <div className='scale-110 pl-14 pr-14 bg-gray-800'>
            <div className='scale-105 p-40 mt-6 mr-1 ml-1 mb-28 bg-blue-500'></div>
          </div>
